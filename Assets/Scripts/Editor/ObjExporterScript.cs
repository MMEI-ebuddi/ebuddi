...
public class ObjExporterScript
{
	...
	public static string MeshToString(Mesh m, Transform t) 
	{	
	...
	static string processTransform(Transform t, bool makeSubmeshes)
	{
		...
		if (t.GetComponent<MeshFilter>() != null) {
			MeshFilter mf = t.GetComponent<MeshFilter>();
			 ...
			 m = t.GetComponent<MeshFilter>().sharedMesh;

			if (mf)
			{
				meshString.Append(ObjExporterScript.MeshToString(m, t));
			}
		}


		else if (t.GetComponent<SkinnedMeshRenderer>() != null) {
			SkinnedMeshRenderer mf = t.GetComponent<SkinnedMeshRenderer>();
			
			m = t.GetComponent<SkinnedMeshRenderer>().sharedMesh;
